...
local RightHip = HumanoidRootPart:WaitForChild("Right Hip")
local LeftHip = HumanoidRootPart:WaitForChild("Left Hip")
...
local animNames = { 
	idle = 	{	
				{ id = "rbxassetid://6785237889", weight = 9 },
				{ id = "rbxassetid://6785237889", weight = 1 }
			},
	walk = 	{ 	
	...
	fall = 	{
				{ id = "rbxassetid://6785441009", weight = 10 } 
			}, 
	climb = {
...
function onRunning(speed)
	if speed > 0.01 then
		...
		if emoteNames[currentAnim] == nil then
			playAnimation("idle", 0.08, Humanoid)
			pose = "Standing"
		end
	end
end
